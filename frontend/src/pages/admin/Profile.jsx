...
/**
 * Admin profile screen. Allows editing name, phone number, and language.
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="plate-lg p-4">
        <label className="eyebrow" htmlFor="aname">{t('yourName')}</label>
        <input
          id="aname" className="field mt-1" value={name}
          onChange={(e) => setName(e.target.value)} maxLength={120}
        />

        <label className="eyebrow mt-4" htmlFor="aphone">
          {t('phoneNumber')}
        </label>
        <input
          id="aphone" className="field mt-1" value={phone}
      ...
      <div className="plate p-3 text-sm">
        <dl className="space-y-1">
          ...
          <Row label="Admin ID" value={user?.profile_id} />
        </dl>
      </div>
